...
// Fixed paths: ../../ goes from Dashboard -> pages -> src
...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      ...
      {/* HERO HEADER */}
      <div className="hero-header" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${agroHero})` }}>
        <nav className="nav">
          <h2>AGROFAMILY</h2>
          <div>
            <span>Dashboard</span>
      ...
      <div className="content-area">
        ...
        <div className="listings">
          ...
          <div className="card" style={{ display: 'block', overflow: 'hidden' }}>
            <img src={training} style={{ width: '100%', height: '200px', objectFit: 'cover' }} alt="Workshop" />
            <div style={{ padding: '20px' }}>
              <h4 style={{ margin: 0 }}>Farmer Education Workshop</h4>
              <button className="card-content button" style={{ marginTop: '15px', width: '100%' }}>Manage Service</button>
            </div>
          </div>
        </div>
