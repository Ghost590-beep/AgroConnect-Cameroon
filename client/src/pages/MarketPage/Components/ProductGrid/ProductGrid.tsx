...
import { FaFilter, FaSortAmountDown, FaMapMarkerAlt, FaShoppingCart } from "react-icons/fa";
...
const ProductGrid: React.FC<Props> = ({
  filtered, sortBy, onSortChange, sidebarOpen,
  onToggleSidebar, onAddToCart, onViewDetails,
}) => (
          ...
          <div className="hm-product-card" key={product.id}>
            ...
            <div className="hm-product-body">
              ...
              <div className="hm-card-btns">
                <button className="hm-details-btn" onClick={() => onViewDetails(product.id)}>
                  View details
                </button>
                <button className="hm-cart-btn" onClick={() => onAddToCart(product)}>
